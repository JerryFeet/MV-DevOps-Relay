-- Sanitized, scope-limited schema-only evidence extracted from the development database.
-- Contains document-library structure only. No INSERT, COPY, row data, storage keys, or credentials.
